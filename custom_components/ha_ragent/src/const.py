...
# Retrieval confidence tuning. Keep candidate-selection thresholds here so
# deployments can tune retrieval behavior from one place.
DEVICE_CONFIDENCE_HIGH_MARGIN = 0.30
DEVICE_CONFIDENCE_HIGH_RATIO = 1.55
DEVICE_CONFIDENCE_MEDIUM_MARGIN = 0.10
DEVICE_CONFIDENCE_MEDIUM_RATIO = 1.18
DEVICE_CONFIDENCE_NEAR_TIE_MARGIN = 0.06
DEVICE_SELECTION_ABSOLUTE_FLOOR = 0.28
DEVICE_SELECTION_RELATIVE_FLOOR = 0.72
DEVICE_SELECTION_GAP_THRESHOLD = 0.12
DEVICE_CONTINUITY_MAX_BOOST = 0.10
DEVICE_REDUNDANCY_PENALTY = 0.20
DEVICE_DIVERSITY_RESCUE_RELATIVE_FLOOR = 0.60
DEVICE_DIVERSITY_RESCUE_IDENTITY_RELATIVE_FLOOR = 0.80
DEVICE_EXPLICIT_IDENTITY_RELATIVE_FLOOR = 0.90
EXPOSURE_BUDGET_DISTRIBUTION_WEIGHT = 0.45
EXPOSURE_BUDGET_TOP_PAIR_WEIGHT = 0.30
EXPOSURE_BUDGET_COVERAGE_WEIGHT = 0.25
EXPOSURE_BUDGET_SOFTMAX_TEMPERATURE = 0.10
EXPOSURE_BUDGET_TOP_PAIR_SEPARATION = 0.30
EXPOSURE_BUDGET_UNCERTAINTY_CURVE = 0.80

TOOL_CONFIDENCE_HIGH_MARGIN = 0.24
TOOL_CONFIDENCE_HIGH_RATIO = 1.40
TOOL_CONFIDENCE_MEDIUM_MARGIN = 0.08
TOOL_CONFIDENCE_MEDIUM_RATIO = 1.14
TOOL_CONFIDENCE_NEAR_TIE_MARGIN = 0.05
TOOL_SELECTION_ABSOLUTE_FLOOR = 0.24
TOOL_SELECTION_RELATIVE_FLOOR = 0.70
TOOL_SELECTION_GAP_THRESHOLD = 0.16
TOOL_STRONG_SEMANTIC_MIN = 0.40
TOOL_STRONG_LEXICAL_MIN = 0.80
TOOL_DEVICE_RELEVANCE_BASE_WEIGHT = 0.25
TOOL_DEVICE_RELEVANCE_SIGNAL_WEIGHT = 0.75
TOOL_BUDGET_DISTRIBUTION_WEIGHT = 0.45
TOOL_BUDGET_TOP_PAIR_WEIGHT = 0.30
TOOL_BUDGET_COVERAGE_WEIGHT = 0.25
TOOL_BUDGET_SOFTMAX_TEMPERATURE = 0.10
TOOL_BUDGET_TOP_PAIR_SEPARATION = 0.30
TOOL_BUDGET_UNCERTAINTY_CURVE = 0.80
